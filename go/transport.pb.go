...
type Transport struct {
	...
	Tensors  map[string]*Tensor `protobuf:"bytes,2,rep,name=Tensors,proto3" json:"Tensors,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (*Transport) Descriptor() ([]byte, []int) {
	return fileDescriptor_transport_a6a51af2304e060f, []int{0}
}
...
func (m *Transport) GetVersion() *Version {
	if m != nil {
		return m.Version
	}
	return nil
...
func (m *Transport) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Version != nil {
		dAtA[i] = 0x22
		i++
		i = encodeVarintTransport(dAtA, i, uint64(m.Version.Size()))
...
func init() { proto.RegisterFile("transport.proto", fileDescriptor_transport_a6a51af2304e060f) }

var fileDescriptor_transport_a6a51af2304e060f = []byte{
	...
	,
	...
	0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x12, 0x1b, 0x38, 0x06, 0x8c, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0xcc, 0x33, 0x1b, 0x05, 0xda, 0x01, 0x00, 0x00,
}
