...
type Tensor struct {
	...
	Dim      []int64           `protobuf:"varint,2,rep,packed,name=Dim,proto3" json:"Dim,omitempty"`
...
func (*Tensor) Descriptor() ([]byte, []int) {
	return fileDescriptor_tensor_4a51a44aa4d1a5c3, []int{0}
}
		...
		case 2:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.Dim) == 0 {
					m.Dim = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
...
func init() { proto.RegisterFile("tensor.proto", fileDescriptor_tensor_4a51a44aa4d1a5c3) }

var fileDescriptor_tensor_4a51a44aa4d1a5c3 = []byte{
	...
	0x42, 0x38, 0x56, 0x4c, 0x16, 0x8c, 0x4e, 0x26, 0x37, 0x1e, 0xca, 0x31, 0x3c, 0x78, 0x28, 0xc7,
	...
	0xd8, 0xc0, 0x01, 0x61, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0xb5, 0x12, 0xa3, 0x0d, 0x4d, 0x01,
	0x00, 0x00,
}
